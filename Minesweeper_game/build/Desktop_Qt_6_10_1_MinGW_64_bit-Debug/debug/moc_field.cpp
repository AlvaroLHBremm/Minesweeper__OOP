...
template <> constexpr inline auto Field::qt_create_metaobjectdata<qt_meta_tag_ZN5FieldE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Field, qt_meta_tag_ZN5FieldE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
void Field::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->resetField(); break;
        case 1: _t->updateTime(); break;
        case 2: _t->setFlag((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->openTile((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 4: _t->count_Right(); break;
        case 5: _t->count_Left(); break;
        default: ;
        }
    }
}
